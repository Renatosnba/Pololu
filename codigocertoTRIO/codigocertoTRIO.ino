...
const char welcome_line2[] PROGMEM = "TrioCGR";
const char demo_name_line1[] PROGMEM = "Labi";
const char demo_name_line2[] PROGMEM = "Rinto";
...
void follow_segment()
{
  ...
  while(1)
  {
    ...
    // to a negative value.
    const int maximum = 62; // the maximum speed
